 ...
 * @author gildo
 */
public class controlemarca extends javax.swing.JFrame {

    /**
     * Creates new form controlemarca
     */
    public controlemarca() {
        initComponents();
        setIconImage(new getImageBack().getImage());
        new marcaDAO().getMarca(table);
    }
    ...
    private void initComponents() {
        ...
        rSButton7.setText("Editar marca");
        ...
        rSButton5.setText("Apagar marca");
        ...
        pesq.setToolTipText("pesquisar marca...");
        ...
        pesq.setPlaceholder("pesquisar marca pelo nome ou id...");
    ...
    private void rSButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButton10ActionPerformed
        ...
        new novamarca(table).setVisible(true);
    ...
    private void rSButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButton7ActionPerformed
        ...
        if(table.isRowSelected(linha))
        {
            ...
            new novamarca(table, ID, nome).setVisible(true);
        }else
        {
    ...
    private void pesqKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pesqKeyReleased
        if(pesq.getText().trim().isEmpty()){ new marcaDAO().getMarca(table, pesq.getText());}
        else
        {
            new marcaDAO().getMarca(table, pesq.getText());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(controlemarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
